...
class TransactionForm(ft.AlertDialog):
    ...
    def _setup_form_controls(self) -> None:
        ...
        on_dismiss=lambda e: self._page.update(),
        help_text=t("datepicker_help_text", default="Seleccionar Fecha"), 
        cancel_text=t("settings_cancel", default="Cancelar"), 
        confirm_text=t("datepicker_confirm", default="Aceptar"),
        error_format_text=t("datepicker_error_format", default="Formato inválido."), 
        error_invalid_text=t("datepicker_error_invalid", default="Fecha fuera de rango."),
        field_hint_text="dd/mm/yyyy", 
        field_label_text=t("transaction_form_field_label_date", default="Ingresar fecha")
    )
